...
func (m *GetFeedsResponse) validateData(formats strfmt.Registry) error {
...
func (m *GetFeedsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
