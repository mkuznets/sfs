...
func (m *GetItemsResponse) validateData(formats strfmt.Registry) error {
...
func (m *GetItemsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
