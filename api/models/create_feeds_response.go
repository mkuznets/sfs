...
func (m *CreateFeedsResponse) validateData(formats strfmt.Registry) error {
...
func (m *CreateFeedsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
