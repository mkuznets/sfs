...
func (m *UploadFilesResponse) validateData(formats strfmt.Registry) error {
...
func (m *UploadFilesResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
	for i := 0; i < len(m.Data); i++ {
		if m.Data[i] != nil {
