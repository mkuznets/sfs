...
func (m *CreateItemsResponse) validateData(formats strfmt.Registry) error {
...
func (m *CreateItemsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
