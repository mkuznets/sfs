...
func (o *CreateItemsOK) Error() string {
	return fmt.Sprintf("[POST /items/create][%d] createItemsOK  %+v", 200, o.Payload)
}
...
func (o *CreateItemsBadRequest) Error() string {
	return fmt.Sprintf("[POST /items/create][%d] createItemsBadRequest  %+v", 400, o.Payload)
}
...
func (o *CreateItemsUnauthorized) Error() string {
	return fmt.Sprintf("[POST /items/create][%d] createItemsUnauthorized  %+v", 401, o.Payload)
}
...
func (o *CreateItemsInternalServerError) Error() string {
	return fmt.Sprintf("[POST /items/create][%d] createItemsInternalServerError  %+v", 500, o.Payload)
}
