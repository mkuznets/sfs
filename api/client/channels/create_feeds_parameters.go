...
type CreateFeedsParams struct {
	...
	/* Request.
	   ...
	   CreateFeeds request
	*/
	Request *models.CreateChannelsRequest
...
func (o *CreateFeedsParams) WithRequest(request *models.CreateChannelsRequest) *CreateFeedsParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the create feeds params
func (o *CreateFeedsParams) SetRequest(request *models.CreateChannelsRequest) {
	o.Request = request
}
