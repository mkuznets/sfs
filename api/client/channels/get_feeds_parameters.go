...
type GetFeedsParams struct {
	...
	/* Request.
	   ...
	   Parameters for filtering channels
	*/
	Request *models.GetChannelsRequest
...
func (o *GetFeedsParams) WithRequest(request *models.GetChannelsRequest) *GetFeedsParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the get feeds params
func (o *GetFeedsParams) SetRequest(request *models.GetChannelsRequest) {
	o.Request = request
}
