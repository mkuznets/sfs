...
type GetFeedsOK struct {
	Payload *models.GetChannelsResponse
}
...
func (o *GetFeedsOK) Error() string {
	return fmt.Sprintf("[POST /channels/get][%d] getFeedsOK  %+v", 200, o.Payload)
}
...
func (o *GetFeedsUnauthorized) Error() string {
	return fmt.Sprintf("[POST /channels/get][%d] getFeedsUnauthorized  %+v", 401, o.Payload)
}
...
func (o *GetFeedsInternalServerError) Error() string {
	return fmt.Sprintf("[POST /channels/get][%d] getFeedsInternalServerError  %+v", 500, o.Payload)
}
