...
type CreateFeedsOK struct {
	Payload *models.CreateChannelsResponse
}
...
func (o *CreateFeedsOK) Error() string {
	return fmt.Sprintf("[POST /channels/create][%d] createFeedsOK  %+v", 200, o.Payload)
}
...
func (o *CreateFeedsOK) GetPayload() *models.CreateChannelsResponse {
	return o.Payload
}
...
func (o *CreateFeedsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.CreateChannelsResponse)
...
func (o *CreateFeedsBadRequest) Error() string {
	return fmt.Sprintf("[POST /channels/create][%d] createFeedsBadRequest  %+v", 400, o.Payload)
}
...
func (o *CreateFeedsUnauthorized) Error() string {
	return fmt.Sprintf("[POST /channels/create][%d] createFeedsUnauthorized  %+v", 401, o.Payload)
}
...
func (o *CreateFeedsInternalServerError) Error() string {
	return fmt.Sprintf("[POST /channels/create][%d] createFeedsInternalServerError  %+v", 500, o.Payload)
}
