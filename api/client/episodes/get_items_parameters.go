...
type GetItemsParams struct {
	...
	/* Request.
	   ...
	   Parameters for filtering episodes
	*/
	Request *models.GetEpisodesRequest
...
func (o *GetItemsParams) WithRequest(request *models.GetEpisodesRequest) *GetItemsParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the get items params
func (o *GetItemsParams) SetRequest(request *models.GetEpisodesRequest) {
	o.Request = request
}
