...
type CreateItemsParams struct {
	...
	/* Request.
	   ...
	   CreateItems request
	*/
	Request *models.CreateEpisodesRequest
...
func (o *CreateItemsParams) WithRequest(request *models.CreateEpisodesRequest) *CreateItemsParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the create items params
func (o *CreateItemsParams) SetRequest(request *models.CreateEpisodesRequest) {
	o.Request = request
}
